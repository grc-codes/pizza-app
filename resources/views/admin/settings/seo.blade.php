            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/admin/settings/seo" class="splash-container">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="description"
                                        value="{{ old('description', $seo_settings->description) }}"
                                        required
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="keywords"
                                        value="{{ old('keywords', $seo_settings->keywords) }}"
                                        required
